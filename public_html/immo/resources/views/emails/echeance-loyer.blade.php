...
<body style="font-family:sans-serif;color:#333;max-width:600px;margin:auto;padding:20px;">
  ...
  <div style="background:#f9fbe7;padding:24px;border:1px solid #f1f8e9;">
    ...
    <div style="background:#fff;border:1px solid #2E7D32;border-radius:10px;padding:15px;margin:15px 0;">
  ...
  <div style="background:#0d1c2e;color:#2E7D32;padding:12px;text-align:center;border-radius:0 0 12px 12px;font-size:11px;">
