...
@section('title',__('general.boutiques'))
...
@section('content')
    <div class="col-12 col-lg-8">
        <div class="card shadow-none">
            <div class="card-body">
                <h3>{{ __('boutique.cartographie') }}</h3>
                <div id="map"></div>
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="row" style="height: 582px;overflow:auto">
            @include('admin.stations.liste')
            @include('layouts.sub_layouts.datatable',['_classTableWrapper'=>'col-md-12'])
        </div>
    </div>


    @include('admin.stations.modal')
    {{-- Datatable extension --}}
