  ...
  <div class="container" style="margin-top: 100px;">
    <div class="d-flex align-items-center justify-content-between mb-4">
      <h4 class="mb-0">
        ...
        Mes Favoris
        <span class="badge" style="background:#2E7D32;color:#fff;border-radius:20px;font-size:13px;">{{ $favoris->count() }}</span>
      </h4>
    ...
    @if($favoris->isEmpty())
      <div class="text-center py-5">
        ...
        <a href="{{ route('accueil') }}" class="btn btn-sm" style="background:#2E7D32;color:#fff;border-radius:20px;">Parcourir les annonces</a>
      </div>
    @else
      <div class="row">
            ...
            <div class="_card border-0 shadow-sm" style="border-radius:12px;overflow:hidden;">
              ...
              <div class="p-3">
                <a href="{{ route('annonce', $annonce->slug) }}" style="text-decoration:none;color:inherit;">
                  <p style="font-weight:bold;margin:0;font-size:16px;color:#2E7D32;">{{ number_format($annonce->prix, 0, '', ' ') }} CFA</p>
