...
<style>
  ...
  .bubble.mine { background: #2E7D32; color: #fff; border-bottom-right-radius: 4px; }
  ...
  .chat-input textarea:focus { border-color: #2E7D32; }
  .chat-input button { background: #2E7D32; color: #fff; border: none; border-radius: 50%; width: 42px; height: 42px; cursor: pointer; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
  .back-btn { color: #2E7D32; font-size: 13px; text-decoration: none; }
</style>
<div style="margin-top: 70px;">
  ...
  <div class="chat-container">
    <div class="chat-header">
      ...
      <div style="width:38px;height:38px;border-radius:50%;background:#2E7D32;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:bold;font-size:16px;flex-shrink:0;">
      ...
      <div>
        ...
        @if($conversation->annonce)
          <p style="font-size:11px;color:#2E7D32;margin:0;">{{ $conversation->annonce->name }}</p>
        @endif
      </div>
    </div>
